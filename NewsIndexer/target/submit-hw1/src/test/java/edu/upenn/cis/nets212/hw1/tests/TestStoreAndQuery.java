package edu.upenn.cis.nets212.hw1.tests;
...
import edu.upenn.cis.nets212.hw1.LoadData;
import edu.upenn.cis.nets212.hw1.QueryForWord;
...
public class TestStoreAndQuery {
	...
	public void testStoreAndQuery() throws DynamoDbException, IOException, InterruptedException {
		...
		int size = results.iterator().next().size();
		assertTrue(size == 1);
