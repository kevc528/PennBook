package edu.upenn.cis.nets212.hw1.files;
	...
	public void readTalkDescriptions(BiConsumer<String[], String[]> processTalk) throws IOException {
		...
		try {
			...
			while ((nextLine = reader.readNext()) != null) {
				...
				// If we are running locally, we need to short circuit because
				// performance is otherwise awful.  We are assuming that one
				// will ONLY test locally in simple ways
